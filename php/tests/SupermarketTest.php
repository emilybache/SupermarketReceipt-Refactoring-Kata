...
class SupermarketTest extends TestCase
{
    ...
    {
        $this->cart->addItem($this->rice);
        $this->teller->addSpecialOffer(SpecialOfferType::tenPercentDiscount(), $this->rice, 10.0);
    ...
    public function xForYDiscount()
    {
        ...
        $this->cart->addItem($this->cherryTomatoes);
        $this->teller->addSpecialOffer(SpecialOfferType::twoForAmount(), $this->cherryTomatoes, 0.99);
    ...
    public function fiveForYDiscount()
    {
        ...
        $this->teller->addSpecialOffer(SpecialOfferType::fiveForAmount(), $this->apples, 6.99);
